...
public class CartService {
    ...
    public List<Cart> queryCartList() {
        ...
        //查询购物车数据
        Stream<Cart> cartStream = carts.stream().map(cart -> JsonUtils.parse(cart.toString(), Cart.class));
        return cartStream.collect(Collectors.toList());
    }
